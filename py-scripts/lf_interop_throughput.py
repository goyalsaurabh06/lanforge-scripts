    ...
    def generate_report(self, iterations_before_test_stopped_by_user, incremental_capacity_list, data=None, data1=None, report_path='', result_dir_name='Throughput_Test_report',
        ...
        if iot_summary:
            ...
            if ort:
                rows = [{
                    "Device": dev,
                    "Min Latency (ms)": stasts.get("min_latency"),
                    "Avg Latency (ms)": stasts.get("avg_latency"),
                    "Max Latency (ms)": stasts.get("max_latency"),
                    "Total Iterations": stasts.get("total_iterations"),
                    "Success Iters": stasts.get("success_iterations"),
                    "Failed Iters": stasts.get("failed_iterations"),
                    "No-Response Iters": stasts.get("no_response_iterations"),
                } for dev, stasts in ort.items()]
