...
# The 'phantom_check' will be handled within the 'get_real_client_list' function
    ...
    def get_real_client_list(self):
        user_list, real_client_list1, real_client_list2, android_list, mac_list, windows_list, linux_list, working_resources_list, eid_list, devices_available, input_devices_list, mac_id_list1, mac_id_list2 = [
        ], [], [], [], [], [], [], [], [], [], [], [], []
        device_found = False
                ...
                if (not port_data['phantom'] and not port_data['down'] and port_data['parent dev'] == "wiphy0" and port_data['alias'] != 'p2p0'):
                    for id in eid_list:
                        if (id + '.' in port):
                            ...
                            mac_id_list1.append(str(LFUtils.name_to_eid(port)[0]) + '.' + str(LFUtils.name_to_eid(port)[1]) + ' ' + port_data['mac'])
        ...
        if (devices_list == "" or devices_list == ","):
            ...
            exit(1)
            return input_devices_list, real_client_list1, mac_id_list2
