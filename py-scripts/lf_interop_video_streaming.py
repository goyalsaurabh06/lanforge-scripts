...
def main():
    ...
    parser.add_argument("--private_key", type=str,default='NA')
    parser.add_argument("--ca_cert", type=str,default='NA')
    parser.add_argument("--client_cert", type=str,default='NA')
    ...
    elif(args.device_list!=None and (args.ssid==None or args.passwd==None or args.encryp==None)):
