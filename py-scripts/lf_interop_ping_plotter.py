...
'''
    ...
    python3 lf_interop_ping_plotter.py --mgr 192.168.207.78  --target 142.250.76.206  --radio 1.1.wiphy0  --ping_interval 5 --ping_duration 1m --debug
    ...
    def __init__(self,
        ...
        if clients_type == "both" or (real and virtual):
            ...
            if not self.sta_to_res:
                ...
                logger.info("As none of the arguments --real --virtual --clients_type --sta_to_res is specified going forward with default type that is Real")
                self.real = True
