...
| Lanforge   | `/home/lanforge/lanforge-scripts/py-scripts/`                    | `DeviceConfig.py` |
| Lanforge   | `/home/lanforge/lanforge-scripts/py-scripts/real_application_tests/` | `install_dependencies.py` |
