...
class ROAMThroughput(RobotClass):
    ...
    def get_signal_and_channel_data(self, station_names):
        ...
        """
        print( "Getting signal and channel data for stations:", station_names)
...
def main():
    ...
    EXAMPLE CLI: python3 lf_bandsteering.py --robot_ip 192.168.210.82 --coordinates 8,9,10 --mgr_ip 192.168.207.78 --port 8080 --download 1000000 --traffic_type lf_tcp --total_roams 50 --upstream_port eth2
    """
