...
class RemoteSniffer:
    ...
    def run_command_and_fetch_folder(self, remote_folder, local_folder=None, mgmt_roam_time=500, data_roam_time=500):
        """
        ...
        command = f"python3 ~/roaming_development/wifi_roaming_cli.py --mode parallel --pcap-dir {remote_folder} --alias-file ./roaming_development/ap_client_aliases.json --report-image ./roaming_development/floor_plan.jpeg --workers 6 --packets-per-chunk 15000 --pcap-batch-workers 3 --traffic-test 'Zoom Call' --auth-pass-ms {mgmt_roam_time} --gap-pass-ms {data_roam_time}"
